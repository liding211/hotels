...
abstract class BaseContentPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (ContentPeer::ID, ContentPeer::TITLE, ContentPeer::CONTENT, ContentPeer::CREATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (ContentPeer::ID => 0, ContentPeer::TITLE => 1, ContentPeer::CONTENT => 2, ContentPeer::CREATED_AT => 3, ),
	...
	{
		include_once 'lib/model/map/ContentMapBuilder.php';
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/ContentMapBuilder.php';
