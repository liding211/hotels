 ...
 * @version    SVN: $Id: sfDoctrineAdminColumn.class.php 7956 2008-03-18 22:12:42Z Jonathan.Wage $
 */
class sfDoctrineAdminColumn extends sfAdminColumn
{
  ...
  function getCreoleType()
  {
    ...
    return ($dType && isset(self::$docToCreole[$dType]))? self::$docToCreole[$dType] : -1;
  }
