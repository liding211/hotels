 ...
 * @version    SVN: $Id: sfDoctrineUniqueValidator.php 6593 2007-12-19 20:31:54Z Jonathan.Wage $
 */
class sfDoctrineUniqueValidator extends sfValidator
{
  ...
  public function execute(&$value, &$error)
  {
    ...
    {
      $primaryKeyValue = $this->getContext()->getRequest()->getParameter($primaryKey);
      if (empty($primaryKeyValue) || strlen($primaryKeyValue) === 0)
      {
